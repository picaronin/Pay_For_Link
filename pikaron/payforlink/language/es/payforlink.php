...
$lang = array_merge($lang, array(
    ...
    // INSTALL
    'PAYFORLINK_PHPBB_ERROR'    => 'Pay For Link NO se puede instalar.<br><br>- Se requiere phpBB 3.3.0 o posterior.',
    'PAYFORLINK_PHP_ERROR'      => 'Pay For Link NO se puede instalar.<br><br>- Se requiere php 7.1.0 o posterior.',
    'PAYFORLINK_OLD_VERSION'    => 'Pay For Link NO se puede instalar.<br><br>Existe una versión obsoleta de la extension instalada.<br><br>Antes de instalar la nueva version, es necesario REALIZAR UNA COPIA DE RESPALDO DE LA TABLA %1$s (para poder restaurarla posteriormente) y desinstalar completamente la version PayForLink_%2$s<br><br>Puede descargar la version obsoleta desde el siguiente enlace <a href="https://www.siteproall.com/PayForLink/PayForLink_%3$s.zip">Descargar PayForLink_%4$s</a>.',
));
