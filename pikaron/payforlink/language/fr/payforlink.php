...
$lang = array_merge($lang, array(
    ...
    // INSTALLER
    'PAYFORLINK_PHPBB_ERROR'    => 'Pay For Link ne peut pas être installé.<br><br>- phpBB 3.3.0 ou ultérieur est requis.',
    'PAYFORLINK_PHP_ERROR'      => 'Impossible d\'installer Pay For Link.<br><br>- php 7.1.0 ou ultérieur requis.',
    'PAYFORLINK_OLD_VERSION'    => 'Pay For Link NE PEUT PAS être installé.<br><br>Une version obsolète de l\'extension est installée.<br><br>Avant d\'installer la nouvelle version, il est nécessaire de FAIRE UNE COPIE DE SAUVEGARDE DE LA TABLE %1$s (pour pouvoir la restaurer ultérieurement) et désinstaller complètement la version PayForLink_%2$s<br><br>Vous pouvez télécharger la version obsolète à partir du lien suivant <a href="https://www.siteproall.com/PayForLink/PayForLink_%3$s.zip">Télécharger PayForLink_%4$s</a>.',
));
