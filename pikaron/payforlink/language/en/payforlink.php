...
$lang = array_merge($lang, array(
    ...
    // INSTALL
    'PAYFORLINK_PHPBB_ERROR'    => 'Pay For Link CANNOT be installed.<br><br>- phpBB 3.3.0 or later is required.',
    'PAYFORLINK_PHP_ERROR'      => 'Pay For Link CANNOT be installed.<br><br>- php 7.1.0 or later is required.',
    'PAYFORLINK_OLD_VERSION'    => 'Pay For Link CANNOT be installed.<br><br>There is an outdated version of the extension installed.<br><br>Before installing the new version, it is necessary to MAKE A BACKUP COPY OF THE TABLE %1$s (to be able to restore it later) and completely uninstall the version PayForLink_%2$s<br><br>You can download the obsolete version from the following link <a href="https://www.siteproall.com/PayForLink/PayForLink_%3$s.zip">Download PayForLink_%4$s</a>.',
));
